        ...
        <div className="flex justify-between">
          <div className="flex-1">
            ...
            <div className="px-4 mt-8 mb-8 flex items-center justify-between md:justify-start gap-2 ">
              ...
              <div className="flex flex-col items-start">
                ...
                <div className="flex items-center space-x-5">
                  ...
                  <div className="flex gap-2 md:gap-16 lg:gap-24 justify-between">
                    <div>
            ...
            <div className="lg:flex w-full">
              ...
              <div className="flex justify-center md:justify-start md:ml-4 items-center">
                <Image
                  src="/QR-code.png"
                  alt="banner"
                  width={150}
          ...
          <div className="hidden lg:flex flex-col items-center justify-between gap-4">
            <div className="m-2">
              <h1 className="text-4xl font-bold text-right hidden md:block">
                Kereta Api
              </h1>
